...
find_sprite_hitbox("../graphics/enemies/wizard/Fire-wizard/Idle.png", "Fire wizard idle", 0, 128, 128, 1.5)
find_sprite_hitbox("../graphics/enemies/wizard/Fire-wizard/Flame_jet.png", "Fire wizard flame jet", 7, 128, 128, 1.5)
